    ...
    <form @submit.prevent="startTimer">
      <div class="grid-x grid-margin-x">
        <div class="cell medium-2 medium-offset-2">
          <label for="development" class="text-left">Develop for</label>
        </div>
      ...
      <div class="grid-x grid-margin-x">
        <div class="cell medium-2 medium-offset-2">
          <label for="inversion" class="text-left">Inversion every</label>
        </div>
      ...
      <div class="grid-x grid-margin-x">
        <div class="cell medium-2 medium-offset-2">
          <label for="stop" class="text-left">Stop for</label>
        </div>
      ...
      <div class="grid-x grid-margin-x">
        <div class="cell medium-2 medium-offset-2">
          <label for="fix" class="text-left">Fix for</label>
        </div>
      ...
      <div class="grid-x grid-margin-x">
        <div class="cell medium-2 medium-offset-2">
          <label for="wash" class="text-left">Wash for</label>
        </div>
        <div class="cell medium-5 medium-offset-1">
          <input
            tabindex="5"
