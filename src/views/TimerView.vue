  ...
  <fullscreen v-model="fullscreen">
    <div class="mw6 center ph3-ns mt2">
      ...
      <div class="fl w-100">
        ...
        <div class="fl w-60-ns w-60 pr2 tr">
          <h1 class="f2" :class="[this.step == 'stop' ? 'black' : 'black-20']">
            {{ clockCountdown("stop") }}
          </h1>
        </div>
      </div>
      ...
      <div class="fl w-100">
        ...
        <div class="fl w-60-ns w-60 pr2 tr">
          <h1 class="f2" :class="[this.step == 'fix' ? 'black' : 'black-20']">
            {{ clockCountdown("fix") }}
          </h1>
        </div>
      </div>
      ...
      <div class="fl w-100">
        ...
        <div class="fl w-60-ns w-60 pr2 tr">
          <h1 class="f2" :class="[this.step == 'wash' ? 'black' : 'black-20']">
            {{ clockCountdown("wash") }}
          </h1>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    pause() {
      ...
      if (this.getReady == true) this.getReady = !this.getReady;
    },
    reset() {
